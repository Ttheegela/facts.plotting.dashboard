...
def _build_stacked_bar_section(
    ...
    default_wf       = wfs[0]
    default_comp     = "total"
    default_scale    = "global" if global_only else "local"
    default_q_key    = "med"
    year_opts        = [str(y) for y in sorted(set(years))]
...
<div style="margin-bottom:8px;">
<br>
  Generated by <code>facts_dashboard.py</code> &mdash;
  developed by <b>Tarun Theegela</b>, Kopp Lab, Rutgers University.<br>
  FACTS (Framework for Assessing Changes To Sea-level) by
  <a href="https://doi.org/10.5194/gmd-16-7461-2023">Kopp et al. (2023)</a>.<br>
